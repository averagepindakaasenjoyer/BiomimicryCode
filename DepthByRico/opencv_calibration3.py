...
LEFT_PATH  = os.path.join(BASE_DIR, "CalibImg/16CM_converted/camera_0_*.jpg")
RIGHT_PATH = os.path.join(BASE_DIR, "CalibImg/16CM_converted/camera_2_*.jpg")
MIN_CORNERS = 15
...
np.savez(
    os.path.join(BASE_DIR, "Cam_Params/stereo_charuco_calibration_16cm_rico.npz"),
